...
public class Praktika extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_praktika);
        praktikaAdapter adapter = new praktikaAdapter(this, makePerson());
        ListView lv = (ListView) findViewById(R.id.listViewPraktika);
